...
// type PostingScreenProps = NativeStackScreenProps<HomeStackParamList, "PostingScreen">;

// export default function PostingScreen({ navigation, route }: PostingScreenProps) {
//   const { theme } = useTheme();
//   const { energyquery } = route.params;
